...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier * w.Weight) + ((math.Pow(meanSpeedMps, 2) / (w.Height / CmInM)) * CaloriesSpeedHeightMultiplier * w.Weight)) * w.Duration.Hours() * MinInHours
}
